...
public class MetriFormatRenderer extends DefaultTableCellRenderer {
	DecimalFormat formatConMetri = new DecimalFormat("#.## 'M'");
	DecimalFormat formatSenzaMetri = new DecimalFormat("#.##");
...
//    		setText(value instanceof Integer ? formatConSegno.format(value) : "");
    		if (Double.parseDouble(value.toString()) != 0){
        		setText(formatConMetri.format(value));
    		} else {
        		setText(formatSenzaMetri.format(value));
    		}
